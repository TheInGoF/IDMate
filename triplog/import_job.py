...
def _write_day_to_influx(device: str, points: list[dict]) -> int:
    ...
    for p in points:
        ...
        # Feldtypen MÜSSEN exakt zu MQTT-Bridge/Replay (app.py) passen, sonst
        # 422 field-type-conflict und der ganze Tag wird verworfen. Einzige
        # Wahrheit: config.influx_field_value / config.INFLUX_INT_FIELDS —
        # niemals hier von Hand casten.
